  ...
  return (
    <nav className="mb-20 flex items-center justify-between py-6">
      ...
      <div className="hidden md:flex gap-10 text-lg font-light">
        ...
        <a href="https://github.com/FardadRahmani/rahmani-it-angebot/raw/main/Angebotsschreiben.pdf" className="hover:text-cyan-500 transition">Angebot-Download (PDF)</a>
      </div>
